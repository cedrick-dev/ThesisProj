...
public class GeoFencingForegroundService extends Service {
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		PendingIntent stopPendingIntent = PendingIntent.getService(this, Constant.GEO_FENCING_SERVICE_REQUEST_CODE,
		...
		query.addListenerForSingleValueEvent(new ValueEventListener() {
			...
			public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
				if (dataSnapshot.exists()) {
					...
					Query geoFencingQuery = databaseReference.child("childs").child(childUID).child("location")
							.child("outOfFence");
	...
	private void showNotification(DataSnapshot dataSnapshot, String childName) {
		...
		// Log.i(TAG, "showNotification: childrenCount" +
			...
			query.addListenerForSingleValueEvent(new ValueEventListener() {
				...
				public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
					if (dataSnapshot.exists()) {
						...
						databaseReference.child("childs").child(childUID).child("location").child("outOfFence")
								.setValue(false);
						databaseReference.child("childs").child(childUID).child("location").child("geoFence")
								.setValue(false);
						stopSelf();
					}
				}
